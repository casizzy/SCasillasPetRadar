...
export class CreatePetRadarTables1773100000000 implements MigrationInterface {
  name = 'CreatePetRadarTables1773100000000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    // Índices espaciales para acelerar ST_DWithin / ST_Distance
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_lost_pets_is_active" ON "lost_pets" ("is_active")`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP INDEX "IDX_lost_pets_is_active"`);
    await queryRunner.query(`DROP INDEX "IDX_found_pets_location"`);
    await queryRunner.query(`DROP INDEX "IDX_lost_pets_location"`);
